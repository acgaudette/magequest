...
// PlayerMage class, representing the player--the player tracks various
// game statistics and levels up automatically via applied XP
...
public:
  ...
  // Calculate XP from a duel with another mage
  // (must be called directly after combat)
  ...
  void ApplyXP(
    ...
    const bool suppressMessage = false
  );
